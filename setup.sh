...
yay --noconfirm -S xorg bspwm sxhkd picom nitrogen polkit-gnome dunst numlockx udiskie polybar rofi alacritty starship copyq xfce4-power-manager neovim network-manager-applet nm-connection-editor thunar thunar-archive-plugin pamixer power-profiles-daemon flameshot gnome-calculator vlc mpv gthumb file-roller htop neofetch sublime-text-4
